        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-slate-600 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-slate-700 text-white"
            />
            <span className="text-xs text-slate-400">{cellPhone.length}/11 dígitos</span>
          </div>

          <div className="border-t pt-3">
            <h3 className="text-sm font-semibold text-slate-300 mb-2">Endereço</h3>
          </div>

          <div>
            <label className="block text-sm font-medium text-slate-300">Rua</label>
            <input
              type="text"
              value={street}
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-300">Bairro</label>
              <input
                type="text"
                value={neighborhood}
          ...
          {apartment && (
            <div>
              <label className="block text-sm font-medium text-slate-300">Número do Apartamento</label>
              <input
                type="text"
      ...
      <div className="mb-4">
        <div className="flex gap-2 items-center">
          <input
            ...
            className="flex-1 px-4 py-2 border border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-slate-700 text-white placeholder-slate-400"
          />
          <select
            value={pageSize}
          ...
          <button
            ...
            className={`px-3 py-2 rounded text-sm ml-2 ${autoSize ? 'bg-blue-600 text-white' : 'bg-slate-700 text-slate-200 hover:bg-pink-200'}`}
